      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        {isMobile && (
          <div className="text-center min-h-[120px] px-4">
            <h4 className="text-sm sm:text-lg md:text-2xl font-bold leading-normal text-black mt-2 sm:mt-4">
              Empowering Salons, Enriching Lives
            </h4>
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-black leading-tight text-[#F25435] py-3">
          ...
          >
            ...
            >
              <div className="relative w-full h-full" style={cardInnerStyle}>
                <div className="w-[280px] sm:w-[350px] md:w-[450px] lg:w-[550px]" style={backfaceHiddenStyle}>
                  <motion.img
                    src={mobileImage}
