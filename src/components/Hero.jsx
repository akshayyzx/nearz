    ...
    return (
      <section className="bg-white min-h-screen flex items-center justify-center px-6 md:px-12">
        <div className="max-w-7xl w-full flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-center">
          ...
          {/* Right Section (Image) - Appears First in Mobile View */}
          ...
          {/* Left Section (Text) - Appears Below Image in Mobile View */}
          <div className="text-center md:text-left">
            <h4 className="text-xl md:text-xl font-bold leading-tight text-black">
              Empowering Salons, Enriching Lives
            </h4>
            <h1 className="text-3xl md:text-5xl font-black leading-tight text-[#F25435] py-6">
              AI-based Salon appointment booking App
            </h1>
            <p className="text-lg md:text-xl mt-4 opacity-90 font-black">
              Revolutionize Your Salon Experience with <strong className="text-[#F25435] text-4xl md:text-xl font-black">Nearz</strong> <br />
              The Effortless Way to Book Appointments
            </p>
    
            {/* Download Badges */}
            <div className="flex gap-12 mt-8 justify-center md:justify-start cursor-pointer">
              <a 
                href="https://apps.apple.com/in/app/nearz/id1549902743" 
                target="_blank" 
